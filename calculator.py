...
button_add = Button(root, text="+", padx=94.5, pady=20, command=button_add)
button_equal= Button(root, text="=", padx=152, pady=20, command=button_equal)
...
button_clear= Button(root, text="Clear", padx=142,pady=20, command=button_clear)
